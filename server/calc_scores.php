...
$sheet->setCellValue('S1', $specs['rol_l_min'] );
$sheet->setCellValue('S2', $specs['rol_l_max'] );
$sheet->setCellValue('S3', $specs['rol_c_min'] );
$sheet->setCellValue('S4', $specs['rol_c_max'] );
$sheet->setCellValue('S5', $specs['rol_w_min'] );
$sheet->setCellValue('S6', $specs['rol_w_max'] );
$sheet->setCellValue('S7', $specs['rol_p_min'] );
$sheet->setCellValue('S8', $specs['rol_p_max'] );
$sheet->setCellValue('S9', $specs['moist_s_min'] );
$sheet->setCellValue('S10', $specs['moist_s_max'] );

// set the formulas
$sheet->setCellValue('A1', $formula['l_outlow'] );
$sheet->setCellValue('A2', $formula['l_outhigh'] );
$sheet->setCellValue('A3', $formula['l_inspec'] );
$sheet->setCellValue('A4', $formula['c_outlow'] );
$sheet->setCellValue('A5', $formula['c_outhigh'] );
$sheet->setCellValue('A6', $formula['c_inspec'] );
$sheet->setCellValue('A7', $formula['w_outlow'] );
$sheet->setCellValue('A8', $formula['w_outhigh'] );
$sheet->setCellValue('A9', $formula['w_inspec'] );
$sheet->setCellValue('A10', $formula['p_outlow'] );
$sheet->setCellValue('A11', $formula['p_outhigh'] );
$sheet->setCellValue('A12', $formula['p_inspec'] );

$sheet->setCellValue('A13', $data['surfout'] );
$sheet->setCellValue('A14', $data['blendacc'] );
$sheet->setCellValue('A15', $data['pdacc'] );
$sheet->setCellValue('A17', $data['tightness'] );

$sheet->setCellValue('A16', $formula['r_batch_score'] );
